...
Feltkoden beskriver referansesystemet på tvers av vegen, og gir oss informasjon om hvilke kjørefelt som finnes i vegens tverrsnitt. Oddetall angir kjøreretning med lenkeretning, partall angir kjøreretning mot lenkeretning.
