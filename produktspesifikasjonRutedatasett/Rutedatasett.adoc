...
NVDB Rutedatasett er et verktøyuavhengig rutedatasett som benyttes til navigasjon. Datasettet har et vegnett segmentert på aktuelle strekningsegenskaper fra NVDB. Vegsperringer, svingerestriksjoner og gjennomkjoring forbudt leveres som egne objekter. Metadata ligger i en egen tabell uten geometri. 
