...
:datasett-teknisk: NVDB_Vegnett_Pluss
:versjon: 1.1
:underversjon: 2026-01-01
:publisert: 2026-01-19
...
=== Innledning
Dette dokumentet er en registreringsinstruks for fotogrammetrisk ajourhold av NVDB Vegnett Pluss.

Fotogrammetrisk NVDB Vegnett Pluss henger tett sammen med fotogrammetrisk FKB-Veg 5.0 og
fotogrammetrisk FKB-TraktorvegSti 5.0. Klassifiseringen av de ulike vegtypene gjøres ut fra listene
for typeVeg (se punkt 3.2) og avgjør om objektet skal kartlegges i NVDB Vegnett Pluss eller FKB-TraktorvegSti.

For full beskrivelse av NVDB Vegnett Pluss og detaljer rundt modellering og UML-modeller henvises det til
SOSI NVDB Vegnett Pluss.

==== Fotogrammetrisk registrering av NVDB Vegnett Pluss
NVDB Vegnett Pluss er ikke et rent FKB-datasett og forvaltes i NVDB. NVDB Vegnett Pluss består av et komplett nettverk av veglenker og mye informasjon (egenskaper/objekter) knyttet til dette nettverket. Det er ikke mulig/hensiktsmessig å vedlikeholde all informasjonen i NVDB Vegnett Pluss ved fotogrammetrisk registrering. Veldig mange egenskaper og en del av veglenkene krever administrativt vedlikehold. 
...
* I kap. 3.2.7. Sykkelfelt i vegbanen registrering av ny typeveg
...
==== Endringer fra versjon 2023-01-01 til versjon 2024-01-01:
...
* Lagt til ny tekst og figur i kap 5.1, Registrering av nye veglenker, om banketter.
...
* *Datafangstdato og stedfestingskvalitet* (metadata for innmåling, Se kapittel 2.1.2. Merk forøvring at _registreringsversjon_ ikke skal registreres på NVDB Vegnett Pluss)
...
.Eksempel på eksisterende konnekteringslenker fra NVDB over en rundkjøringsflate i NVDB Vegnett Pluss.
...
.Kvalitetsklasser for veglenker i NVDB Vegnett Pluss
[cols="4*", options="header"]
|===
|Objekttype
