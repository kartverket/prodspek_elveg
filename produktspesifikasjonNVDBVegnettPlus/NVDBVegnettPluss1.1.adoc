...
Vedtaksregister for skiltvedtak: endringer på objekttyper som har en sammenheng med trafikkskilt for å sikre en god integrering mellom vedtaksregisteret og NVDB. Egenskaper: «vedtaksnummer», «arkivnummer» og «gyldigFraDato» leges til objekttyper: Svingerestriksjon, Motorveg, TillattKjøreretning, Gågatereguleringer, Trafikkreguleringer, GjennomkjøringForbudt og Høydebegrensning
