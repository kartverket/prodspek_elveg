...
:underversjon: 2025-09-01
:publisert: 2025-09-29
:dokumentstatus: 1
...
==== Endringer fra NVDB Vegnett Pluss 1.0 til NVDB Vegnett Pluss 1.1

*Vedtaksregister for skiltvedtak:* Endringer på objekttyper som har en sammenheng med trafikkskilt for å sikre en god integrering mellom 
vedtaksregisteret og NVDB. Egenskapene «vedtaksnummer», «arkivnummer» og «gyldigFraDato» er lagt til på objekttypene Svingerestriksjon, Motorveg, TillattKjøreretning, Gågatereguleringer, Trafikkreguleringer, GjennomkjøringForbudt og Høydebegrensning

*Fartsgrenser på privat veg:* Objekttypen Fartsgrense får ny egenskap for å kunne begrunne avvik fra generelle fartsgrenser på privat veg. Ny egenskap «Merknad» har tre tillatte verdier: «Privat skiltet», «Privat veg innenfor fartsgrensesone» og «Privat adkomst». 

*Feilretting på SOSI-tagger:* Rettet SOSI-tagger (SOSI_lengde/SOSI_datatype) på en del egenskaper slik at det samsvarer med datatype. Alle egenskaper med datatype boolean har SOSI_datatype BOOLSK

==== Endringer fra Elveg 2.0 til NVDB Vegnett Pluss 1.0

I forhold til Elveg 2.0 er følgende endringer gjort:
