...
:skjema-url: {skjemabase-url}{datasett-teknisk}/{versjon}
:prodspek-url: {prodspekbase-url}{datasett-teknisk}
:uml-url: {umlbase-url}{datasett-teknisk}/{versjon}
:reginstr-url: {reginstrbase-url}{datasett-teknisk}/{versjon}/{reginstr-type}_{underversjon}
:reginstr-url-ny: {reginstrbase-url}{datasett-teknisk}/{versjon-ny}/{reginstr-type}_{underversjon-ny}
:reginstr-url-erstatter: {reginstrbase-url}{datasett-erstatter}/{versjon-erstatter}/{reginstr-type}_{underversjon-erstatter}
